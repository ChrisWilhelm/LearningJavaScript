...
const poll = {
  ...
  registerNewAnswer: function () {
    ...
    if (!(choice > 3 || choice < 0) && Number.isInteger(choice)) {
      this.choices[choice]++;
    }
    this.displayResults(this.choices);
  },
...
const displayR = poll.displayResults([5, 2, 3]);
...
And now explain to YOURSELF (or someone around you) WHY this worked! Take all the time you need. Think about WHEN exactly the callback function 
